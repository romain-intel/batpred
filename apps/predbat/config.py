...
CONFIG_ITEMS = [
    ...
    },
    {
        ...
        "default": 4,
        "reset_inverter": True,
        "enable": "num_inverters",
        "enable_condition": "num_inverters > 1",
    },
    {
        ...
        "reset_inverter": True,
        "enable": "num_inverters",
        "enable_condition": "num_inverters > 2",
    },
    {
        ...
        "reset_inverter": True,
        "enable": "num_inverters",
        "enable_condition": "num_inverters > 3",
    },
    {
    ...
    {
        "name": "car_charging_solar",
        "friendly_name": "Charge car on excess solar",
        "type": "switch",
        "default": False,
        "enable": "num_cars",
        "enable_condition": "num_cars > 0",
    ...
    {
        "name": "car_charging_rate_threshold_export",
        "friendly_name": "Car solar charging export rate threshold",
        "type": "input_number",
        "min": -10,
        "max": 99,
        "step": 1,
...
APPS_SCHEMA = {
    ...
    "battery_charge_power_curve": {"type": "int_float_dict", "or_auto": True},
    "battery_discharge_power_curve": {"type": "int_float_dict", "or_auto": True},
    ...
    "vpp_control": {"type": "boolean"},
    "vpp_calendar": {"type": "sensor", "sensor_type": "string"},
    "vpp_active": {"type": "sensor", "sensor_type": "boolean"},
    "sigenergy_app_key": {"type": "string", "empty": False},
    ...
    "sigenergy_client_pem": {"type": "string", "empty": False},
    "sigenergy_client_key": {"type": "string", "empty": False},
    ...
    "fox_inverter_sn": {"type": "string|string_list", "empty": False},
    ...
    "deye_battery_nominal_voltage": {"type": "float"},
